    ...
    CKEDITOR.dialog.add("flash", function (a) {
        ...
        return {
            ...
            onOk: function () {
                ...
                else if (g && (e = CKEDITOR.dom.element.createFromHtml("<object></object>", a.document), e.setAttributes({
                ...
                if (e)
                    for (var b = {}, c = e.getElementsByTag("param","" ), f = 0, j = c.count(); f < j; f++) b[c.getItem(f).getAttribute("name")] = c.getItem(f);
                c = {};
                f = {};
              ...
              /**
                ...
                e.setAttributes(f);
                e.setStyles(c);
              this.fakeImage ? (e.replace(this.fakeImage), a.getSelection().selectElement(e)) :**/ 
               a.insertElement(e)
