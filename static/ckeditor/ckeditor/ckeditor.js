...
*/
    ...
    (function () {
        CKEDITOR.plugins.add("youtube", {
            lang: "en pt ja hu it fr tr ru de".split(" "),
            init: function (a) {
                    ...
                    return {
                            ...
                            elements: [{
                                ...
                                children: [{
                                    ...
                                    validate: function () {
                                        if (this.isEnabled())
                                            if (this.getValue()) {
                                                if (b = ytVidId(this.getValue()), 0 === this.getValue().length || !1 === b) return alert(a.lang.youtube.invalidUrl), !1
                                            } else return alert(a.lang.youtube.noCode), !1
                                    }
                                }, {
                                    type: "text",
                        ...
                        onOk: function () {
                            ...
                            if (this.getContentElement("youtubePlugin", "txtEmbed").isEnabled()) a = this.getValueOf("youtubePlugin", "txtEmbed");
                                ...
                                var a = "//",
                                    c = [],
                                    d, f = this.getValueOf("youtubePlugin", "txtWidth"),
                                    g = this.getValueOf("youtubePlugin", "txtHeight"),
                                    a = !0 === this.getContentElement("youtubePlugin", "chkPrivacy").getValue() ? a + "www.youtube-nocookie.com/" : a + "www.youtube.com/",
                                    a = a + ("embed/" + b);
